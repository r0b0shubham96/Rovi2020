...
std::vector<rw::math::Q> getConfigurations(const std::string nameGoal, const std::string nameTcp, rw::models::SerialDevice::Ptr robot, rw::models::WorkCell::Ptr wc, rw::kinematics::State state)
{
    ...
    // This function was provided in Robotics, Exercise 5
...
rw::math::Q getCollisionFreeSolution(rw::models::SerialDevice::Ptr UR5, rw::kinematics::State state, rw::proximity::CollisionDetector::Ptr detector, std::vector<rw::math::Q> solutions)
{
    rw::math::Q configuration;
    for ( unsigned int i = 0; i < solutions.size(); i++ )
    {
        UR5->setQ(solutions[i], state);
...
rw::math::Q getCollisionFreeSolution(rw::models::SerialDevice::Ptr UR5, rw::kinematics::State state, rw::proximity::CollisionDetector::Ptr detector, std::vector<rw::math::Q> solutions, rw::math::Q prevSolution)
{
    rw::math::Q configuration;
...
std::vector<rw::math::Q> mapCartesianToJoint( std::vector<rw::math::Transform3D<>> CPath, rw::kinematics::MovableFrame *targetFrame, rw::models::SerialDevice::Ptr UR5, rw::models::WorkCell::Ptr wc, rw::kinematics::State state, rw::proximity::CollisionDetector::Ptr detector )
{
...
/***********************************************************************************************************
  ...
  **********************************************************************************************************/
  ...
  std::vector<rw::math::Q> linerInterpolateQ(std::vector<rw::math::Transform3D<>> Ts, std::vector<float> Times, rw::kinematics::MovableFrame *targetFrame, rw::models::SerialDevice::Ptr UR5, rw::models::WorkCell::Ptr wc, rw::kinematics::State state, rw::proximity::CollisionDetector::Ptr detector)
  ...
  std::tuple<std::vector<rw::math::Q>,std::vector<rw::math::Transform3D<>>> linearInterpolate(std::vector<rw::math::Transform3D<>> P, std::vector<float> T, rw::kinematics::MovableFrame *targetFrame, rw::models::SerialDevice::Ptr UR5, rw::models::WorkCell::Ptr wc, rw::kinematics::State state, rw::proximity::CollisionDetector::Ptr detector)
  {   // Linear in cartesian space
      ...
      for ( unsigned int i = 1; i < P.size(); i++ )
      {
          ...
          for ( float t = T[i-1]; t < T[i]; t += 0.01f )
          {
              ...
              rw::math::Q configuration;
              if ( path.size() > 0 )
                  configuration = interpolator::util::getCollisionFreeSolution(UR5, state, detector, solutions, path.back());
              else
                  configuration = interpolator::util::getCollisionFreeSolution(UR5, state, detector, solutions);
